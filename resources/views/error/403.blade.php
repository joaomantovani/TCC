	...
	<div class="ui centered grid">
		<div class="six wide tablet eight wide computer column">
			...
			<div class="text-editor-wrap">
				<div class="title-bar"><span class="title">permissao-negada.js — bash — 80x<span class="terminal-height">10</span></span></div>
				<div class="text-body">
			...
			<div class="fluid ui buttons" id="opening1_buttons">
			  <a href="{{ url('/home') }}" class="ui black button">Ok, entendi...</a>
			</div>
...
<script type="text/javascript">
	var fsm = new StateMachine({
		init: 'opening',
		transitions: [
			{ name: 'opening1',  from: 'opening', to: 'finish' },
		],
		methods: {
			onOpening1: function() { 
				var typed2 = new Typed('#opening1', {
				    strings: ['Ops...', 'Você ainda não pode entrar nesse local', 'Aparentemente seu level não é alto suficiente', 'Tente novamente depois de upar uns leveis'],
				    typeSpeed: 40,
				    backSpeed: 10,
				    fadeOut: true,
				    loop: false,
